...
class SidewaysShooter:
    ...
    def __init__(self):
        ...
        self.play_button = Button(self, "Let's shoot!")
    ...
    def _check_bullet_alien_collisions(self):
        ...
        if self.stats.aliens_hit_left > 0:
            # Remove any bullets and aliens that have collided
            collisions = pygame.sprite.groupcollide(
                self.bullets, self.aliens, True, True
            )
            # Decrease number of aliens to hit
            if collisions:
                self.stats.aliens_hit_left -= 1
            if not self.aliens:
    ...
    def _create_fleet(self):
        ...
        while current_x > (3 * alien_width):
            ...
            # Finished a column; reset y value, and decrement x value
            current_y = alien_height
            current_x -= 2 * alien_width

    def _create_alien(self, x_position, y_position):
        """Create an alien and place it on the fleet."""
